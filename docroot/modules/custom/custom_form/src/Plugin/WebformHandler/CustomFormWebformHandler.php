 ...
 *   description = @Translation("Custom form submission handler."),
 *   cardinality = \Drupal\webform\Plugin\WebformHandlerInterface::CARDINALITY_SINGLE,
 * )
 */
class CustomFormWebformHandler extends WebformHandlerBase {
  ...
  public function submitConfigurationForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->configuration['custom_message'] = $form_state->getValue('wil')['settings'];
  }
  ...
  public function alterForm(array &$form, FormStateInterface $form_state, WebformSubmissionInterface $webform_submission) {
    ...
    $form['actions']['submit']['#ajax'] = [
      'callback' => [$this, '_custom_ajx'],
      'type' => 'throbber',
    ];
  }

  public function _custom_ajx(array &$form, FormStateInterface $form_state) {

    $message = $this->configuration['custom_message'];
